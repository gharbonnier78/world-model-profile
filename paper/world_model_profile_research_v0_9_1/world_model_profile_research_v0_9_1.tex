...
\large Post-v0.6 Research Draft v0.9.1 --- Independent-Review Repairs Only}
...
\subsection{Agent E: weakening a strong recursive-state requirement}
...
Toy C v0.4 & H closed-form $K$ on horizon-4/5/6 & $32704/32704$ \\
Toy C v0.4 & H without update $U$ on new depth-3 histories & $0/28672$ defined \\
Toy C v0.4 & M branch-conditioned evidence queries & $2336/2336$ \\
Toy C v0.4 & delegated F branch: with O / O removed & $2336/2336$ / $0/2336$ defined \\
Toy C v0.4 & H/G branch-conditioned interface & not implemented \\
