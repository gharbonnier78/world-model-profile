...
\large Post-v0.6 Research Draft with Toy C Extensions}
...
\begin{itemize}
    ...
    \item In a post-v0.6 falsification cycle, Toy C separates current-state sufficiency from future-query capability, then tests a genuinely information-losing predictive quotient and a direct-history sequence predictor before any new framework layer is considered.
\end{itemize}
