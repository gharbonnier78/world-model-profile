...
history/
  v0.1-review-cycle/ Initial working definition and first review cycle.
  v0.2-spine/        First L0–L3 formalisation and finite toy.
  v0.3-spine/        Bidirectional-separation revision and reviewer package.
...
The repository was populated from the exact review ZIP packages. Their original filenames and SHA-256 values are recorded in [`archive/IMMUTABLE_PACKAGE_MANIFEST.md`](archive/IMMUTABLE_PACKAGE_MANIFEST.md). A reproducible source import bundle is stored under `archive/import-bundles/`. Historical generated PDF/PNG duplicates are not repeated outside their original packages; the accepted v0.4 PDF is kept directly in the navigable framework tree.
